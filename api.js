...
// end-point akses data pelanggaran berdasarkan id_pelanggaran
...
// end-point akses data user berdasarkan id_user
...
// end-point login user (authentication)
app.post("/user/auth", (req,res) => {
    // tampung username & password
    let param = [
